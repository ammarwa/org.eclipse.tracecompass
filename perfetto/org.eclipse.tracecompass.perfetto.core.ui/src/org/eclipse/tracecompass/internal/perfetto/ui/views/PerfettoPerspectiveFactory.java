...
package org.eclipse.tracecompass.internal.perfetto.ui.views;
...
/**
 * Perfetto Trace perspective factory
 * @author Francois Chouinard
 */
public class PerfettoPerspectiveFactory implements IPerspectiveFactory {
    ...
    /** The perspective ID */
    public static final String ID = perfettoUIPlugin.PLUGIN_ID + ".perspective"; //$NON-NLS-1$
